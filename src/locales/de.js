export default {
  ...
  wishlist: {
    title: 'Wunschliste',
    subtitle: 'Bücher, die Sie für später gespeichert haben',
    empty: 'Noch keine Bücher auf der Wunschliste.',
    toggle: 'Zur Wunschliste hinzufügen',
    added: 'Zur Wunschliste hinzugefügt',
    removed: 'Von der Wunschliste entfernt',
    error: 'Liste konnte nicht aktualisiert werden',
  },
  aiChat: {
    open: 'Buchassistent',
    title: 'BibliotecaTC Assistent',
    welcome: 'Beschreiben Sie ein Thema, Fach oder einen Autor — ich schlage passende Bücher aus unserem Katalog vor.',
    placeholder: 'z. B. ein Philosophiebuch empfehlen...',
    thinking: 'Denke nach...',
    viewBook: 'Buch im Katalog ansehen',
    error: 'Keine Antwort erhalten. Bitte erneut versuchen.',
    noApiKey: 'Der Assistent ist derzeit nicht verfügbar.',
    loginRequired: 'Bitte melden Sie sich an, um den Assistenten zu nutzen.',
  },
  navbar: { 
  ...
  bookDetails: {
    ...
    noDescription: 'Keine Beschreibung für dieses Buch. Nutzen Sie die Schaltfläche unten, um eine KI-Zusammenfassung zu erstellen.',
    noDescriptionGuest: 'Keine Beschreibung verfügbar. Melden Sie sich an, um eine KI-Zusammenfassung zu erstellen.',
    generateSummaryLogin: 'Anmelden, um Zusammenfassung zu erstellen',
  ...
  myLoans: {
    ...
    subtitle: 'Ausleihen und Wunschliste',
    tabs: {
      loans: 'Ausleihen',
      wishlist: 'Wunschliste',
    },
