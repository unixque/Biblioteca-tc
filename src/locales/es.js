export default {
  sidebar: { discover: 'Descubrir', myLibrary: 'Mi Biblioteca', overview: 'Resumen', books: 'Libros', categories: 'Categorías', loans: 'Préstamos', users: 'Usuarios', administration: 'Administración', settings: 'Configuración', admin: 'Admin', feedback: 'Feedback' },
  navbar: { 
  ...
  bookDetails: {
    ...
    noDescription: 'No hay descripción disponible para este libro.',
