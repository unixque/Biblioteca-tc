export default {
  sidebar: { discover: 'Ontdekken', myLibrary: 'Mijn Bibliotheek', overview: 'Overzicht', books: 'Boeken', categories: 'Categorieën', loans: 'Leningen', users: 'Gebruikers', administration: 'Administratie', settings: 'Instellingen', admin: 'Admin', feedback: 'Feedback' },
  navbar: { 
  ...
  bookDetails: {
    ...
    noDescription: 'Geen beschrijving beschikbaar voor dit boek.',
