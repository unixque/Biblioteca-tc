export default {
  ...
  wishlist: {
    ...
    subtitle: 'Livres enregistrés pour plus tard',
    empty: 'Aucun livre dans vos favoris pour le moment.',
    toggle: 'Ajouter aux favoris',
    added: 'Ajouté aux favoris',
    removed: 'Retiré des favoris',
    error: 'Impossible de mettre à jour la liste',
  },
  aiChat: {
    open: 'Assistant livres',
    title: 'Assistant BibliotecaTC',
    welcome: 'Décrivez un thème, une matière ou un auteur — je suggérerai des livres adaptés dans notre catalogue.',
    placeholder: 'Ex : recommandez un livre de philosophie...',
    thinking: 'Réflexion...',
    viewBook: 'Voir le livre dans le catalogue',
    error: 'Impossible de répondre. Réessayez.',
    noApiKey: "L'assistant n'est pas disponible pour le moment.",
    loginRequired: "Connectez-vous pour utiliser l'assistant.",
  },
  navbar: { 
  ...
  bookDetails: {
    ...
    noDescription: 'Aucune description pour ce livre. Utilisez le bouton ci-dessous pour générer un résumé IA.',
    noDescriptionGuest: 'Aucune description. Connectez-vous pour générer un résumé IA.',
    generateSummaryLogin: 'Se connecter pour générer un résumé',
  ...
  myLoans: {
    ...
    subtitle: 'Emprunts et liste de souhaits',
    tabs: {
      loans: 'Emprunts',
      wishlist: 'Favoris',
    },
